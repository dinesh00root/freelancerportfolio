...
const Herosection: React.FC = () => {
  return (
    <section className="min-h-[100vh] flex flex-col justify-center items-center px-6 text-center  ">
      {/* HEADLINE */}
      <h1 className="text-4xl md:text-6xl font-extrabold text-gray-800 mt-20 mb-4 leading-tight dark:text-white">
      Building Modern Web {' '}
      <br />
      ...
      <p className="max-w-2xl text-gray-800 mb-6 dark:text-white">
        ...
        I deliver <span className="text-purple-700 font-semibold">100% client satisfaction</span> through
      ...
      <div className="flex flex-wrap gap-4 justify-center">
        <a
           ...
           target='_blank'
          className="px-6 py-3 bg-gradient-to-r from-purple-500 to-blue-500 text-white font-semibold rounded-full shadow-lg hover:opacity-90 transition"
        >
          Start Your Project →
        </a>
        <a
  ...
  <div className="px-4 py-2 rounded-full bg-blue-100 text-blue-900 dark:bg-blue-500 dark:text-white shadow-sm">
